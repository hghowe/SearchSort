...
/*
 * SearchSortFrame.java
 *
 * Created on Feb 9, 2011, 2:58:31 PM
 */
...
public class SearchSortFrame extends javax.swing.JFrame implements ThreadCompletedDelegate,Constants
{
    ...
    // Note: this VERY long method, initComponents(), was created by a GUI editor from
    // another program. It's about 450 lines!
    // It is hard to read and should probably be broken up into smaller
    // methods, but that's the difference between a computer writing code, and a human
    // programmer. Please: a) DO NOT alter this method without talking to Mr. Howe, and
    // b) DO NOT consider this a good example of coding!
    ...
    private void initComponents() {
        ...
        // deprecated from NetBeans
       /* GroupLayout barPanelLayout = new GroupLayout(barPanel);
        barPanel.setLayout(barPanelLayout);
        barPanelLayout.setHorizontalGroup(
            barPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING).add(0, 1083, Short.MAX_VALUE)
        );
        barPanelLayout.setVerticalGroup(
            barPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .add(0, 222, Short.MAX_VALUE)
        );
*/
        // these two lines are the replacement for Eclipse.
       ...
       /* org.jdesktop.layout.GroupLayout layout = new org.jdesktop.layout.GroupLayout(getContentPane());
        ...
        layout.setHorizontalGroup(
            ...
            .add(jSplitPane1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 1087, Short.MAX_VALUE)
        );
        ...
        // the next two lines are the replacement for Eclipse.
    ...
    private void ManualResetBottonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ManualResetBottonActionPerformed
        statsThread.reset();
    }//GEN-LAST:event_ManualResetBottonActionPerformed

    private void AutoResetCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AutoResetCheckBoxActionPerformed
        AbstractSearchSortThread.setAutoReset(AutoResetCheckBox.isSelected());
    ...
    private void updateGetDelay(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_updateGetDelay
        reviseGetDelay();
    }//GEN-LAST:event_updateGetDelay

    private void updateSetDelay(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_updateSetDelay
        reviseSetDelay();
    }//GEN-LAST:event_updateSetDelay

    private void updateCompareDelay(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_updateCompareDelay
        reviseCompareDelay();
    }//GEN-LAST:event_updateCompareDelay

    private void updateGetCheckbox(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateGetCheckbox
        reviseGetDelay();
    }//GEN-LAST:event_updateGetCheckbox

    private void updateSetCheckbox(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateSetCheckbox
        reviseSetDelay();
    }//GEN-LAST:event_updateSetCheckbox

    private void updateCompareCheckbox(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateCompareCheckbox
        reviseCompareDelay();
    }//GEN-LAST:event_updateCompareCheckbox

    private void handleMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_handleMouseMoved
        String info = mainArray.getSelectedBarInfo((int)((evt.getX()-10)/SortableBar.getBarWidth()));
        barInfoLabel.setText(info);
    }//GEN-LAST:event_handleMouseMoved

    private void handlePauseResumeButton(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_handlePauseResumeButton
    ...
    }//GEN-LAST:event_handlePauseResumeButton

    private void handleStepButton(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_handleStepButton
       activeThread.stepProcess();
    }//GEN-LAST:event_handleStepButton
    ...
    private void handleNewMenuItem(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_handleNewMenuItem
    ...
    private void handleOpenMenuItem(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_handleOpenMenuItem
        ...
        doOpen();
    }//GEN-LAST:event_handleOpenMenuItem

    private void handleSaveMenuItem(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_handleSaveMenuItem
        if (null == theFile)
            handleSaveAsMenuItem(evt);
        else
            doSave();
    }//GEN-LAST:event_handleSaveMenuItem

    private void handleSaveAsMenuItem(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_handleSaveAsMenuItem
        JFileChooser chooser = new JFileChooser();
        chooser.setSelectedFile(theFile);
        chooser.setMultiSelectionEnabled(false);
    ...
    }//GEN-LAST:event_handleSaveAsMenuItem

    private void handleRevertMenuItem(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_handleRevertMenuItem
        doOpen();
    }//GEN-LAST:event_handleRevertMenuItem
    ...
    /**
     * performs the mechanics of writing the mainArray to "theFile."
     */
    private void doSave()
    {
        try
    ...
    /**
     * performs the mechanics of opening "theFile," reading in its contents
     * and loading that information into the mainArray.
     */
    private void doOpen()
    {
        try
    ...
    /**
     * updates the status field in the GUI with the string associated with the
     * given status code.
     * @param s - the status code, based on AbstractSearchSortThread.
     */
    ...
    /**
     * Shows an input dialog to the user, requesting for the value of the Bar
     * to find.
     * @return the value requested, or -1, if the user cancels the dialog.
     */
